...
namespace epexgui
{
    public static class WireguardBoosterExports
    {
        ...
        public struct WgbInterface
        {
            ...
            public string private_key; // required
            [MarshalAs(UnmanagedType.LPStr)]
        ...
        {
            [MarshalAs(UnmanagedType.LPStr)]
            public string public_key; // required
            [MarshalAs(UnmanagedType.LPStr)]
            public string preshared_key; // optional
            [MarshalAs(UnmanagedType.LPStr)]
            public string allowed_ips; // required
            [MarshalAs(UnmanagedType.LPStr)]
        ...
        {
            [MarshalAs(UnmanagedType.LPStr)]
            public string allowed_apps; // optional
            [MarshalAs(UnmanagedType.LPStr)]
            public string ignored_ips; // optional
            [MarshalAs(UnmanagedType.LPStr)]
            public string socks5_proxy; // optional
        }
        ...
        public static extern bool wgb_create_tunnel_from_file(IntPtr wgboosterHandle, [MarshalAs(UnmanagedType.LPStr)] string fileName);

        [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool wgb_create_tunnel_from_file_w(IntPtr wgboosterHandle, [MarshalAs(UnmanagedType.LPWStr)] string fileName);
        ...
        [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool wgbp_create_tunnel_from_file(IntPtr wgboosterHandle, [MarshalAs(UnmanagedType.LPStr)] string fileName);

        [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool wgbp_create_tunnel_from_file_w(IntPtr wgboosterHandle, [MarshalAs(UnmanagedType.LPWStr)] string fileName);
